...
def show_post(post_id):
    ...
    if cmt_form.validate_on_submit():
        ...
        new_comment = Comment(
            comment_text=cmt_form.comment.data,
            comment_author=current_user,
            parent_post=requested_post
        )
        db.session.add(new_comment)
        db.session.commit()
    return render_template("post.html", post=requested_post, form=cmt_form, current_user=current_user)
